...
import { CartService, type AddCartInput } from './cart.service.js';
...
export class CartController {
  ...
  add(@CurrentUser() user: AuthUser, @Body() body: AddCartInput) {
  ...
  selectAll(@CurrentUser() user: AuthUser, @Body() body: { selected: boolean }) {
    return this.cart.selectAll(user.sub, body.selected);
  }
}
